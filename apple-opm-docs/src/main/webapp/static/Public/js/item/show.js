...
$(function(){
  ...
  function change_page(page_id){
      ...
      $(".page-edit-link").show();
      $("#page-content").attr("src" , base_url+"/detail?page_id="+page_id);
      $("#edit-link").attr("href" , base_url+"/edit?page_id="+page_id);
      $("#delete-link").attr("href" , base_url+"/delete?page_id="+page_id);
  }
